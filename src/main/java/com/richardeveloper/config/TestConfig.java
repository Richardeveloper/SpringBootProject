...
import com.richardeveloper.entities.OrderItem;
import com.richardeveloper.entities.Payment;
import com.richardeveloper.entities.Product;
import com.richardeveloper.entities.User;
import com.richardeveloper.entities.enums.OrderStatus;
import com.richardeveloper.repositories.CategoryRepository;
import com.richardeveloper.repositories.OrderItemRepository;
import com.richardeveloper.repositories.OrderRepository;
import com.richardeveloper.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2020-03-30T19:53:07Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2020-01-14T03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2020-06-21T15:21:22Z"), OrderStatus.WAITING_PAYMENT, u1);
		...
		Payment pay1 = new Payment(null, Instant.parse("2020-03-30T22:53:07Z"), o1);
		o1.setPayment(pay1);
